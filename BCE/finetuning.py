...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument("--llama_model_path", default="/home/qsyang2/ckpts/ChatDoctor-7B", type=str, help="path of llama model")
    ...
    # Dataset parameters
    parser.add_argument("--data_path", default="/home/qsyang2/datasets/llm-sft/KC/", type=str, help="dataset path")
